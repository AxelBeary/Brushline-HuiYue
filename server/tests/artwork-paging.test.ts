...
function insertArtwork(artistId: number, overrides: Record<string, unknown> = {}) {
...
describe('作品分页 (Artwork Paging)', () => {
  ...
  describe('公开端 GET /api/public/artworks/:artistId', () => {
    ...
    it('TC-PG-11: 公开分页限流 30/分（31 次后 429）', async () => {
      const opts = { method: 'GET' as const, url: `/api/public/artworks/${artist.id}`, remoteAddress: '203.0.113.77' }
