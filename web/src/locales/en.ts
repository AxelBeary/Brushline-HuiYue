export default {
  errors: {
    ...
    SUBDOMAIN_FORMAT: 'Home ID must be 2-20 lowercase letters/digits/hyphens',
...
loadRetry: 'Try again', networkError: 'Network error, please try again later', globalError: 'Something went wrong. Please refresh and try again.',
  ...
  admin: {
    ...
    subdomainLabel: 'Home ID', subdomainPlaceholder: 'e.g. alice (lowercase letters/digits/hyphens)',
  ...
  setup: {
    ...
    step2SubdomainFormat: 'Home ID must be 2-20 lowercase letters, digits, or hyphens',
  ...
  invite: {
    ...
    subdomainFormat: 'Home ID must be 2-20 lowercase letters/digits/hyphens',
