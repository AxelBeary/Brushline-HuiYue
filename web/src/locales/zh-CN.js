...
loadRetry: '再试一次', networkError: '网络错误，请稍后重试', globalError: '页面出了点小问题，请刷新重试',
 ...
 dashModulesLabel: '看板显示',
 dashModulesHint: '关闭后仪表盘隐藏对应模块，随时可恢复。',
 dashModuleSchedule: '排期卷轴',
 dashModuleGuestbook: '留言审核',
 dashModuleActivity: '订单动态',
 dashModuleOnboarding: '开张任务',
  ...
  admin: {
    ...
    artistSearchPlaceholder: '搜昵称 / 子域名 / QQ / 简介',
    artistStatusAll: '全部状态',
    artistFilterCount: '筛出 {n} 位画师',
    artistFilterLabel: '筛选画师',
    artistFilterDesc: '按昵称、子域名、QQ 或简介搜索，可按状态过滤',
    artistActions: '画师操作',
  ...
  tour: {
    ...
    welcome: '这是你的小前台：每天的问候、今日新单和收入都贴在这里。点一下文字还能换个心情。',
    todo: '账本待办把「下一步该做什么」排成一行行按钮，点一下就能推进订单，不用到处翻。',
    queue: '排期看板是你的订单时间线：谁先谁后、什么状态，拖一拖就能重新排队。',
    manual: '客户在私聊里约稿？把消息粘进这里，QQ、需求、金额都能随手录成一笔订单。',
    orders: '所有订单都在这里：搜索、筛选、点进详情，一眼找到你想找的那一单。',
    pricing: '价格管理是画风的价目表：画风、尺寸、基础价，还有流程和折扣码都在这儿。',
    addons: '增项库是「加购菜单」：加急、商用、加购项都做成模板，客户下单时直接勾选。',
    toolbox: '工具箱把所有小工具都收进了一个抽屉：记账、导出、水印、算价器都在里面。',
    watermark: '图片水印：给展示图盖上你的名字或 logo，发出去不怕被拿去乱用。',
    priceCalc: '稿价计算器：客户问价时先自己算一遍，跟客户看到的口径一致，心里有底。',
    preferences: '偏好设置是「顺手」的地方：字号、面板开关、快捷按钮，都按你的习惯来。',
    settings: '主页设置管的是客户看到的门面：资料、展示内容、模板风格都在这调。'
  },
