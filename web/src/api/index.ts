...
export const artistApi = {
  ...
  getIncomeByStyle: (params: { months?: number } = {}): Promise<import('./types.js').IncomeByStyleResult> =>
    getJson('/artist/tools/income-by-style', { params }),
  getTopClients: (params: { months?: number; limit?: number } = {}): Promise<import('./types.js').TopClientsResult> =>
