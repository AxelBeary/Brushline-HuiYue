...
export const useThemeStore = defineStore('theme', () => {
  ...
  function setBase(b: string): void { base.value = b }
  function setAccent(a: string): void { accent.value = a }
