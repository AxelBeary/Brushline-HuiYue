 ...
 */
export function targetSize(presetKey: string, customW: string | number, customH: string | number | null | undefined): { width: number, height: number | null } {
...
export function autoHeight(srcW: number, srcH: number, dstW: number): number | null {
 ...
 */
export function coverRect(srcW: number, srcH: number, dstW: number, dstH: number): { dw: number, dh: number, dx: number, dy: number } {
...
/** 校验自定义尺寸：1-10000 的整数 */
export function isValidCustomDims(width: string | number | null | undefined, height: string | number | null | undefined): boolean {
 ...
 */
export function resizeImageToBlob(image: HTMLImageElement, { width, height, quality }: { width: number, height: number | null, quality: number }): Promise<Blob> {
