...
export function normalizeAnimSpeed(value) {
...
export function writeAnimSpeed(speed) {
...
export function applyAnimSpeed(speed) {
  const n = normalizeAnimSpeed(speed)
...
/** 清理：移除存储并摘掉 dataset */
export function clearReduceMotion() {
