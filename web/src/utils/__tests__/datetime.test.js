...
const FULL_OPTS = { year: 'numeric', month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit' }

/** 与实现相同的方式把 UTC 字符串转本地时间字符串 */
const local = (isoUtc, opts = FULL_OPTS) => new Date(isoUtc).toLocaleString(undefined, opts)
