...
export function mapStageToStatus(stages, idx) {
...
export function findStageForStatus(stages, status) {
 ...
 * 初始节点状态选项管理
 *
 * @param {import('vue').Ref<Array>} stages 工作流节点列表（camelCase，含 takesPayment）
 * @returns {{ initialStatus: Ref<string>, options: ComputedRef, findTarget: Function }}
 */
export function useStageStatus(stages) {
