...
| 批次 | 内容 | 负责 | 状态 |
|------|------|------|------|
| v0.24-A | #9 展示柜 + #10 三态 + #6 录单入口 + #2 统计卡可点击 | 三号（后端）→ 二号（前端） | ✅ 全部合入（`cd13de3`） |
...
|------|------|---------------|----------|
| 二号 | v0.24-B 接稿设置独立 + 名额概览改版 | `feat/v024-b-settings` / `../artist-commission-fe` | `01-to-02-v024-b-settings-20260802.md` |
