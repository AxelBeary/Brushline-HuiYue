...
> 🔜 **围剿剩余**：b5 键盘热区 a11y 波；前端 P1 汇总波（a1×16 竞态/b1×22/b2×3/b3×7/b4×14）；d1 P2×8（F3 计数原子性/F4 退款快照/F5 version 覆盖/F6 试探限流/F7 发布幂等/F8 交付存校/F9 终态收款/F10 备注事务）；P2 汇总给用户（~180 条）。
