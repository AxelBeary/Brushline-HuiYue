...
|------|--------------|------|------|
| 三号 | — | A 路：后端引擎接线 | ✅ 已合入 `3aea46f` |
| 二号 | artist-commission-manualstyle（待重建分支） | D 路补漏批：REQ-029 用户拍板缺口（R2 提示 / R5 自定义增项 / R6 图片开关 / B2 取消选中） | 📋 待开工（派工已写） |
| 五号 | — | C 路：demo-data 切流 | ✅ 已合入 `eb0b4d0` |
| 四号 | — | 需求深聊批：REQ-026/027/028/029/030 + REQ-022 回写 + 传播修改 | ✅ 已落库 `13fa28d`（REQ-030 随收尾补入） |
