...
> 最后更新：2026-08-07 v22（v0.42 开工）——**容器已重建 = master `ba546a4`（v0.41 全部 + 巡检A报告更新）**。备份 `bak-pre-v041-rebuild-2026-08-07T12-52-29-186Z`（integrity ok，orders 8/artists 5/events 219 与生产一致）。三层验证全过（anon-token/迁移v45表/新dist）。基线 server **971/971** · web **215/215** · tsc 0 · **全库 any 0**。**v0.42 已开工：动画修复批/UI 优化批待派**。
