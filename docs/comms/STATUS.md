...
> 最后更新：2026-08-09 v45（大量批次合入 + 四路执行中）——master `2b0f9a8` 与 origin 同步。**npm 0.44.0**。**容器已重建 = master `3b8a1cb`**（v0.44 全批上线）。备份 `bak-pre-v044-rebuild-2026-08-08T15-50-37-912Z`（integrity ok）。**AUTH_DEV_MODE=false**。
