...
> 815 两轮深度审计（P0=0）修复全量收口 + 用户亲裁 12 项拍板全部落地；基线 server 1462→1491 / web 540→545 / E2E 11，迁移链 v64→v66。
...
- **P1 剩余 5 项未修（如实记录）**：P1-3 乐观锁前端全面接线（双开改价静默覆盖）/ P1-5 向导 TOTP 确认无防爆破 / P1-7 原生部署 Sentry 配置失效 / P1-8 双目录启动双库分裂 / P1-10 e2e 邀请码与上传交付链路缺失（E2E 加固批已部分缓解）。待后续立小项。
